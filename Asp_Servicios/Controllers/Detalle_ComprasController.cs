...
namespace Asp_Servicios.Controllers
{
    ...
    {
        private IDetalle_ComprasAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public Detalle_ComprasController(IDetalle_ComprasAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorTipo()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Detalle_Compras>(
