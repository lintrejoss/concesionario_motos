...
namespace asp_servicios.Controllers
{
    ...
    {
        private IMotosAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public MotosController(IMotosAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorTipo()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Motos>(
