...
namespace Asp_Servicios.Controllers
{
    ...
    {
        private IDetalle_VentasAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public Detalle_VentasController(IDetalle_VentasAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorTipo()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Detalle_Ventas>(
