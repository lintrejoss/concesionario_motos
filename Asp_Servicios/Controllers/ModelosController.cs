...
namespace Asp_Servicios.Controllers
{
    ...
    {
        private IModelosAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public ModelosController(IModelosAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorTipo()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Modelos>(
